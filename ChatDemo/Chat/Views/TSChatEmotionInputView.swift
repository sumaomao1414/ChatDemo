...
class TSChatEmotionInputView: UIView {
    ...
    override func awakeFromNib() {
        ...
        let itemWidth = (kSCREEN_WIDTH - 10 * 2) / kNumberOfOneRow
        let padding = (kSCREEN_WIDTH - kNumberOfOneRow * itemWidth) / 2.0
        let paddingLeft = padding
        let paddingRight = kSCREEN_WIDTH - paddingLeft - itemWidth * kNumberOfOneRow
