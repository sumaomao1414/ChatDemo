...
class TSChatActionBarView: UIView {
    ...
    @IBOutlet weak var inputTextView: UITextView! { didSet{
        ...
        inputTextView.layer.borderColor = UIColor.lightGray.cgColor;        inputTextView.layer.borderWidth = 1
...
//        recordButton.setBackgroundImage(UIImage.ts_imageWithColor(UIColor.lightGray), for: .normal)
